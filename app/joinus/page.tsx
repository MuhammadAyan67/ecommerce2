                ...
                <Image
                    ...
                    <div className="flex flex-col justify-center items-center gap-4 mt-3">
                        ...
                        <div className="flex justify-between gap-x-10">
                            <Button  className="w-36 h-10 bg-white border-[#BCBCBC] rounded-xs text-[#BCBCBC] "  >Male</Button>
                            <Button className="w-36 h-1 p-4 bg-white border-[#BCBCBC] rounded-xs text-[#BCBCBC]"  >Women</Button>
                        </div>
                    </div>
                        
                    <div className="flex justify-between max-w-[280px] mx-auto mt-6">
                        <h1 className="text-[#BCBCBC] text-[12px] flex text-center justify-center gap-1 items-center"></h1>
                    </div>
                    <div className="flex flex-col justify-center items-center mt-4">
                        <p className="text-[#BCBCBC] text-[12px]">Sign up for emails to get updates from Nike on products, offers and your Member benefits</p>
